...
export const API_ENDPOINTS = {
  ...
  KNOWLEDGE: {
    ...
    DOCUMENT_DETAIL: '/knowledge/documents',
    DOCUMENT_CHUNKS: '/knowledge/documents',
    DOCUMENT_DOWNLOAD: '/knowledge/documents',
